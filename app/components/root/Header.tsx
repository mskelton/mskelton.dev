    ...
    <header
      className={twMerge(
        ...
        variant === "home"
          ...
          : "flex h-full animate-[header_1ms_linear_both] flex-col bg-white pb-2 transition-colors duration-300 [animation-timeline:scroll()] [animation-range:0_80px] dark:bg-zinc-900",
        variant === "main" && "-top-6",
      )}
    >
      <Container className="w-full">
        <div className="relative flex items-center gap-4">
          <Link className="-m-2 -mt-0.5 rounded-sm p-2 focusable" href="/">
            <CursiveName
              className="w-40"
              swoop={variant === "home"}
