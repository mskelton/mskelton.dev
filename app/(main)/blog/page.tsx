...
function Article({ article }: ArticleProps) {
  return (
    <article className="md:grid md:grid-cols-4 md:items-baseline">
      ...
      <Card.Eyebrow
        as="time"
        className="mt-1 hidden after:absolute after:left-[-37px] after:top-[4px] after:hidden after:h-4 after:w-4 after:rounded-full after:border-4 after:border-zinc-300 after:bg-zinc-100 dark:after:border-zinc-600 dark:after:bg-zinc-800 md:block md:after:block"
        dateTime={article.date}
      >
        {formatDate(article.date)}
      </Card.Eyebrow>
