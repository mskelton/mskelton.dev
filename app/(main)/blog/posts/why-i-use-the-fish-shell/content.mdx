...
well. Not only can you cycle through candidate options when pressing
<kbd>Tab</kbd>, but it also gives you predictive suggestions as you type
based on your shell history, making it dead simple to execute commands
repeatedly.
