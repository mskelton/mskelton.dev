export default function Component() {
  return (
    <div className="relative h-[320px] overflow-y-scroll">
      <div className="sticky top-0 mb-4 w-full animate-[header_1ms_linear_both] rounded-t-lg px-4 py-3 text-xl font-bold [animation-range:0_80px] [animation-timeline:scroll()]">
        Lorem AI
      </div>
