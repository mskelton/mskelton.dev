...
_There is no significance to the fact that the id in this example is a date-like
string. I happen to store bytes with a date like id, but any unique id would
work in the exact same way._
