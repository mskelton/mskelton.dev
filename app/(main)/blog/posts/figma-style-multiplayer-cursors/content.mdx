...
application a bit of color, I'm using the [hashbow](https://npm.im/hashbow)
package to generate a random color based on the name of the user. We'll use this
color as the background of the arrow and the user's name.
